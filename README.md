...
Objetivos Específicos
    ...
    Métodos de pago
        ...
        Incluir un apartado donde el cliente
        pueda realizar sus pagos de manera
        virtual o si se encuentra en un punto
        físico manejar los diferentes
        métodos de pago

    Inicio de sesión

        Desarrollar una sección para que los usuarios tengan un
        inicio de sesión para identificarlos como clientes

    Selección de productos

        Manejar un módulo donde el cliente registrado sea
        capaz de seleccionar los productos que desea


    Gestión administrativa

        Diseñar un área donde el
        administrador pueda gestionar los
        diferentes usuarios y tener control
        sobre lo que se realiza en el
        aplicativo

    Gestión de inventario

        Desarrollar un apartado que
        permita al personal de bodega la
        gestión del inventario, es decir,
        editar, eliminar y consultar un
        producto

    Control de compras

        Controlar todas las compras que se realizan para llevar
        un registro de las mismas

    Gestión de proveedores

        Gestionar los proveedores para identificar cuál es más
        conveniente
...
Todo esto va dirigido a la comunidad de ciclistas que se encuentra en
Bogotá para satisfacer las necesidades de sus bicicletas. 
